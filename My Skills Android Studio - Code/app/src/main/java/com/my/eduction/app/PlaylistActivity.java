...
public class PlaylistActivity extends AppCompatActivity {
	...
	private DatabaseReference db = _firebase.getReference("batch/course1/video");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		listview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				intent.putExtra("Name", map_list.get((int)_position).get("video_title").toString());
				intent.putExtra("dis", map_list.get((int)_position).get("video_discription").toString());
				intent.putExtra("url", map_list.get((int)_position).get("video_url").toString());
				intent.putExtra("img", map_list.get((int)_position).get("video_img_url").toString());
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			if (map_list.get((int)_position).containsKey("video_title")) {
				title.setText(map_list.get((int)_position).get("video_title").toString());
			}
			if (map_list.get((int)_position).containsKey("video_discription")) {
				dis.setText(map_list.get((int)_position).get("video_discription").toString());
			}
			if (map_list.get((int)_position).containsKey("video_url")) {
				url.setText(map_list.get((int)_position).get("video_url").toString());
			}
