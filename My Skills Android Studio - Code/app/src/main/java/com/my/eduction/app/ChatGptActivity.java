...
public class ChatGptActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		webview1.setVisibility(View.GONE);
		linear1.setVisibility(View.VISIBLE);
		webview1.loadUrl("https://share.cody.bot/9c03acbd-b3d4-40b5-8e61-3dc203edabf2");
	}
	...
	public void _ui() {
		s3.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)18, 0xFFE0E0E0));
		s.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)18, 0xFF9FA8DA));
		s2.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)18, 0xFF9FA8DA));
		s4.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)18, 0xFFE0E0E0));
	}
